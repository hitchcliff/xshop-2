...
if (isset($_SESSION['form_profile'])) {
        ...
        <div class="row gx-4 gy-3">
          ...
          <div class="col-sm-6">
            ...
            <input class="form-control" type="email" id="account-email"
              value="<?php echo $_SESSION['customer']['email'] ?>" disabled>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
              ...
              <button name="form_profile" class="btn btn-primary mt-3 mt-sm-0" type="button">Update profile</button>
            </div>
          </div>
        </div>
      </form>
