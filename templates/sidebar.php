            ...
            <div class="d-md-flex align-items-center">
                <div class="img-thumbnail rounded-circle position-relative flex-shrink-0 mx-auto mb-2 mx-md-0 mb-md-0"
                    style="width: 6.375rem;"><span class="badge bg-warning position-absolute end-0 mt-n2"
                        data-bs-toggle="tooltip" title="Reward points">384</span><img class="rounded-circle" src="
                        <?php if (isset($_SESSION['customer']['photo'])) {
                            echo BASE_URL . $_SESSION['customer']['photo'];
                        } else {
                            echo BASE_URL . "dist-front/img/shop/account/avatar.jpg";
                        } ?>"
                        alt="<?php echo $_SESSION['customer']['first_name'] . " " . $_SESSION['customer']['last_name']; ?>">
                </div>
                <div class="ps-md-3">
                    <h3 class="fs-base mb-0">
                        <?php echo $_SESSION['customer']['first_name'] . " " . $_SESSION['customer']['last_name']; ?>
                    </h3><span class="text-accent fs-sm"><?php echo $_SESSION['customer']['email']; ?></span>
                </div>
        ...
        <div class="d-lg-block collapse" id="account-menu">
            ...
            <ul class="list-unstyled mb-0">
                <li class="border-bottom mb-0"><a
                        class="nav-link-style d-flex align-items-center px-4 py-3 <?php echo (basename($_SERVER['PHP_SELF']) == 'dashboard.php') ? 'active' : ''; ?>"
                        href="<?php echo BASE_URL; ?>dashboard.php"><i class="ci-bag opacity-60 me-2"></i>Orders<span
                ...
                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3"
                        href="<?php echo BASE_URL; ?>account-wishlist.html"><i
                ...
                <li class="mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3"
                        href="<?php echo BASE_URL; ?>account-tickets.html"><i
            ...
            <ul class="list-unstyled mb-0">
                <li class="border-bottom mb-0"><a
                        class="nav-link-style d-flex align-items-center px-4 py-3 <?php echo (basename($_SERVER['PHP_SELF']) == 'account-profile.php') ? 'active' : ''; ?>"
                        href="<?php echo BASE_URL; ?>account-profile.php"><i class="ci-user opacity-60 me-2"></i>Profile
                        info</a></li>
                <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3"
                        href="<?php echo BASE_URL; ?>account-address.html"><i
