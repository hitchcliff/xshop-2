        ...
        <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
          <div class="card product-card">
            <button class="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left"
              ...
              href="shop-single-v1.html"><img src="<?= ADMIN_URL . $product_img ?>" alt="<?= $product_name ?>"></a>
            <div class="card-body py-2"><a class="product-meta d-block fs-xs pb-1" href="#"><?= $product_category ?></a>
              <h3 class="product-title fs-sm"><a href="shop-single-v1.html"><?= $product_name ?></a></h3>
              <div class="d-flex justify-content-between">
                <div class="product-price"><span class="text-accent">$<?= number_format($product_price, 2) ?></span></div>
